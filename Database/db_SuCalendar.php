...
if ($received_data->action == 'fetchSingle') {
    $query = "
 SELECT meetingroom.NameRoom_ID, Sday, Stime, Etime, Description FROM nameroom,meetingroom  WHERE meetingroom.NameRoom_ID = nameroom.NameRoom_ID and MeetingRoom_ID = '" . $received_data->MeetingRoom_ID . "'
 ";
